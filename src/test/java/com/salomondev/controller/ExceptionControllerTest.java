package com.salomondev.controller;

import com.salomondev.exception.ApiRestException;
import com.salomondev.exception.controller.ExceptionController;
...
class ExceptionControllerTest {
    ...
    void handleGeneralException_returnsErrorDto() {
        ...
        ApiRestException ex = new ApiRestException(code, HttpStatus.NOT_FOUND, message);
